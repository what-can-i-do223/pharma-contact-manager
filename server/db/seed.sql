...
-- reps last: contacts/orders/activities reference it with RESTRICT.
DELETE FROM reps;

-- ----------------------------------------------------------------------------
-- The demo rep (Phase 7) — owner of every seeded row below.
-- ----------------------------------------------------------------------------
-- google_sub is a sentinel, not a real Google account: the demo rep exists so
-- seed data has an owner and so tenant isolation can be tested without real
-- OAuth. A real rep appears the first time someone completes Google login.
-- (To hand the seed data to your real account after first login, see
-- server/db/adopt-seed.sql.)
--
-- \set defines a psql substitution variable — :'demo_rep' below expands to
-- this UUID. It keeps 60+ inserts readable, at the cost that seed.sql must
-- run through psql (which npm run db:seed does).
\set demo_rep 'bbbbbbbb-0000-4000-8000-000000000001'

INSERT INTO reps (id, google_sub, email, name) VALUES
  (:'demo_rep', 'demo-rep|not-a-real-google-sub', 'demo.rep@example.com', 'Demo Rep');
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000001', 'Dr. Asha Mehta', 'hcp',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000002', 'Dr. Rajiv Kulkarni', 'hcp',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000003', 'Dr. Priya Nair', 'hcp',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000004', 'Dr. Sanjay Gupta', 'hcp',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000005', 'Dr. Farhan Sheikh', 'hcp',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000006', 'Dr. Kavita Rao', 'hcp',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000007', 'Suresh Patil', 'pharmacist',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000008', 'Meena Joshi', 'pharmacist',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000009', 'Arun Verma', 'pharmacist',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000010', 'Divya Shetty', 'pharmacist',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000011', 'Ramesh Iyer', 'procurement',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000012', 'Anita Deshpande', 'procurement',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000013', 'Vikram Malhotra', 'procurement',
...
INSERT INTO contacts (rep_id, id, full_name, contact_type, phone, email, city, status, tier, workplace_id, created_at, updated_at) VALUES
  (:'demo_rep', 'cccccccc-0000-4000-8000-000000000014', 'Pooja Reddy', 'procurement',
...
--
-- Phase 7: the INSERT…SELECT wrapper stamps the demo rep's id onto every
-- row without repeating it 20+ times in the VALUES list below.
INSERT INTO activities (contact_id, rep_id, kind, body, created_at)
SELECT v.contact_id::uuid, :'demo_rep'::uuid, v.kind, v.body, v.created_at
FROM (VALUES
...
) AS v(contact_id, kind, body, created_at);
...
INSERT INTO orders (rep_id, id, contact_id, order_date, status, delivered_at, total_amount) VALUES
  (:'demo_rep', 'eeeeeeee-0000-4000-8000-000000000001', 'cccccccc-0000-4000-8000-000000000007',
...
INSERT INTO orders (rep_id, id, contact_id, order_date, status, delivered_at, total_amount) VALUES
  (:'demo_rep', 'eeeeeeee-0000-4000-8000-000000000002', 'cccccccc-0000-4000-8000-000000000007',
...
INSERT INTO orders (rep_id, id, contact_id, order_date, status, delivered_at, total_amount) VALUES
  (:'demo_rep', 'eeeeeeee-0000-4000-8000-000000000003', 'cccccccc-0000-4000-8000-000000000008',
...
INSERT INTO orders (rep_id, id, contact_id, order_date, status, delivered_at, total_amount) VALUES
  (:'demo_rep', 'eeeeeeee-0000-4000-8000-000000000004', 'cccccccc-0000-4000-8000-000000000011',
...
INSERT INTO orders (rep_id, id, contact_id, order_date, status, delivered_at, total_amount) VALUES
  (:'demo_rep', 'eeeeeeee-0000-4000-8000-000000000005', 'cccccccc-0000-4000-8000-000000000012',
...
INSERT INTO orders (rep_id, id, contact_id, order_date, status, delivered_at, total_amount) VALUES
  (:'demo_rep', 'eeeeeeee-0000-4000-8000-000000000006', 'cccccccc-0000-4000-8000-000000000014',
...
-- (Same INSERT…SELECT wrapper as the block above: stamps rep_id per row.)
INSERT INTO activities (contact_id, rep_id, kind, body, created_at)
SELECT v.contact_id::uuid, :'demo_rep'::uuid, v.kind, v.body, v.created_at
FROM (VALUES
